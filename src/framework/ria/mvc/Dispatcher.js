...
NAMESPACE('ria.mvc', function () {
    ...
    CLASS('Dispatcher', [
        ...
        ria.async.Future, function loadControllers(context) {
            this.loadControllers_(ria.reflection.ReflectionFactory(ria.mvc.Controller), context)
        },
                ...
                try {
                    ...
                    do {
                        ...
                        if (!this.controllers.hasOwnProperty(state.getController())) {
                            ...
                            throw new hwa.mvc.MvcException('Controller with id "' + state.getController() + '" not found');
                        }
